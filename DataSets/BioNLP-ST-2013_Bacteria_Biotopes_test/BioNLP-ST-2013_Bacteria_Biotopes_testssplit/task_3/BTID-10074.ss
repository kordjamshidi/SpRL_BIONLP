...
Description
Bartonella. Bartonella species are facultative intracellular pathogens infecting humans and other animals.
Transmission of these organisms is often through an insect vector.
Once in a host, this intracellular pathogen is internalized by an actin-dependent mechanism, and primarily targets endothelial cells, although other cells can be infected.
...
Bartonella tribocorum has been isolated from blood of wild rats and from fleas obtained from wild rats.
This organism is genetically related to Bartonella elizabethae which was isolated from a case of endocarditis in a human.
Description
Bartonella tribocorum CIP 105476.
This organism was isolated from the blood of wild rats.
This is the type strain and will be used for comparative genomics.
Properties
