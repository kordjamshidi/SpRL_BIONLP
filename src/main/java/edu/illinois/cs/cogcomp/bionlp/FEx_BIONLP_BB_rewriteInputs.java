...
public class FEx_BIONLP_BB_rewriteInputs {
...
//	l.lemmasToString();
	//x.lemmatizeByLexicon("bacteria", "NNS");
//String v=l.lemmasToString();
	    ...
	    String strDirectoryin ="./DataSets/BioNLP-ST-2013_Bacteria_Biotopes_train_dev/task_1/"; // The directory of the output database files
		(new File(strDirectoryin)).mkdirs();
		File f = new File("./DataSets/BioNLP-ST-2013_Bacteria_Biotopes_train_dev/BioNLP-ST-2013_Bacteria_Biotopes_train_mcccj/task_1/");
    	File fsource=new File("./DataSets/BioNLP-ST-2013_Bacteria_Biotopes_train_dev/task_1/");
		File splitsource=new File("./DataSets/BioNLP-ST-2013_Bacteria_Biotopes_train_dev/BioNLP-ST-2013_Bacteria_Biotopes_trainssplit/task_1/");
    	File t1a2=new File("./DataSets/BioNLP-ST-2013_Bacteria_Biotopes_train_dev/task_1/");
    	File Cocoa=new File("./DataSets/BioNLP-ST-2013_Bacteria_Biotopes_cocoa/"); 
